...
function renderTabla() {
  ...
  const renderRow = (j, i) => `
    <tr onclick="openJugador('${j.id}')" style="animation-delay:${i * 0.02}s">
      ...
      <td class="nombre">
        ${j.bref_id ? `<img class="player-thumb" src="https://www.basketball-reference.com/req/202106291/images/players/${j.bref_id}.jpg" onerror="this.style.display='none'" alt="">` : ''}
        ${j.nombre}
      </td>
...
function buildFicha(j) {
  ...
  return `
    <div class="ficha-header">
      ${j.bref_id ? `<img class="player-photo" src="https://www.basketball-reference.com/req/202106291/images/players/${j.bref_id}.jpg" onerror="this.style.display='none'" alt="${j.nombre}">` : ''}
      <div>
